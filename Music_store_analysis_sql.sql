...
--Q3: What are the top 3 total value of invoice
...
--    of invoice totals. Retuen both the city name & sum of all 
--    invoice totals.
...
--Q5: Who is the best  customer? The customer who has spwnt the most 
--    money will be declared the best customer. Write a query that 
--    returns the person who spent the most money.
...
--MODERATE
--Q1: Write a query to return email, first name, last name,
--    & genre of alll rock music listeners. Return your list 
